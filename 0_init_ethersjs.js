...
export const constructorAbi = ['constructor(string memory name, string memory symbol, bytes32 merkleroot)']
export const ownerOfFunctionAbi = ["function ownerOf(uint256) view returns (address)"]
export const mintFunctionAbi = ["function mint(address account, uint256 tokenId, bytes32[] calldata proof) external"]
